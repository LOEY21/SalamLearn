...
const List<AyahBuilderLevel> ayahBuilderLevels = [
  AyahBuilderLevel(
    ...
    englishMeaning: 'In the name of Allah, the Most Compassionate, the Most Merciful.',
  ),
  AyahBuilderLevel(
    id: 'ayah-fatiha-1',
...
const List<GreetingQuestion> greetingQuestions = [
  GreetingQuestion(
    ...
    choices: [
      GreetingChoice(translit: 'Marhaban', meaning: 'Hello / Welcome.', emoji: '👋', correct: false),
      GreetingChoice(translit: 'As-salāmu ʿalaykum', meaning: 'Peace be upon you.', emoji: '🕊️', correct: true),
      GreetingChoice(translit: 'Maʿa as-salāmah', meaning: 'Goodbye.', emoji: '🤗', correct: false),
      GreetingChoice(translit: 'Wa ʿalaykum as-salām', meaning: 'And peace be upon you too.', emoji: '🤲', correct: false),
    ],
  ),
  GreetingQuestion(
    id: 'greet2',
    ...
    choices: [
      GreetingChoice(translit: 'Wa ʿalaykum as-salām', meaning: 'And peace be upon you too.', emoji: '🤲', correct: true),
      GreetingChoice(translit: 'Ahlan wa sahlan', meaning: 'Welcome!', emoji: '😊', correct: false),
      GreetingChoice(translit: 'Ilā al-liqāʾ', meaning: 'See you again.', emoji: '🤝', correct: false),
      GreetingChoice(translit: 'As-salāmu ʿalaykum', meaning: 'Peace be upon you.', emoji: '🕊️', correct: false),
    ],
  ),
  GreetingQuestion(
    id: 'greet3',
    ...
    arabic: 'مَرْحَبًا',
    choices: [
      GreetingChoice(translit: 'Masāʾ al-khayr', meaning: 'Good evening.', emoji: '🌆', correct: false),
      GreetingChoice(translit: 'Ahlan wa sahlan', meaning: 'Welcome!', emoji: '😊', correct: false),
      GreetingChoice(translit: 'Marhaban', meaning: 'Hello / Welcome.', emoji: '👋', correct: true),
      GreetingChoice(translit: 'Ṣabāḥ al-khayr', meaning: 'Good morning.', emoji: '🌅', correct: false),
    ],
  ),
  GreetingQuestion(
    id: 'greet4',
    ...
    arabic: 'أَهْلاً وَسَهْلاً',
    choices: [
      GreetingChoice(translit: 'Ahlan wa sahlan', meaning: 'Welcome!', emoji: '😊', correct: true),
      GreetingChoice(translit: 'Masāʾ an-nūr', meaning: 'Good evening (reply).', emoji: '🌙', correct: false),
      GreetingChoice(translit: 'Marhaban', meaning: 'Hello / Welcome.', emoji: '👋', correct: false),
      GreetingChoice(translit: 'Ṣabāḥ an-nūr', meaning: 'Good morning (reply).', emoji: '☀️', correct: false),
    ],
  ),
  GreetingQuestion(
    id: 'greet5',
    ...
    choices: [
      GreetingChoice(translit: 'Ṣabāḥ an-nūr', meaning: 'Good morning (reply).', emoji: '☀️', correct: false),
      GreetingChoice(translit: 'Ṣabāḥ al-khayr', meaning: 'Good morning.', emoji: '🌅', correct: true),
      GreetingChoice(translit: 'As-salāmu ʿalaykum', meaning: 'Peace be upon you.', emoji: '🕊️', correct: false),
      GreetingChoice(translit: 'Masāʾ al-khayr', meaning: 'Good evening.', emoji: '🌆', correct: false),
    ],
  ),
  GreetingQuestion(
    ...
    choices: [
      GreetingChoice(translit: 'Ṣabāḥ an-nūr', meaning: 'Good morning (reply).', emoji: '☀️', correct: true),
      GreetingChoice(translit: 'Wa ʿalaykum as-salām', meaning: 'And peace be upon you too.', emoji: '🤲', correct: false),
      GreetingChoice(translit: 'Ṣabāḥ al-khayr', meaning: 'Good morning.', emoji: '🌅', correct: false),
      GreetingChoice(translit: 'Masāʾ an-nūr', meaning: 'Good evening (reply).', emoji: '🌙', correct: false),
    ],
  ...
  GreetingQuestion(
    ...
    choices: [
      GreetingChoice(translit: 'Maʿa as-salāmah', meaning: 'Goodbye.', emoji: '🤗', correct: false),
      GreetingChoice(translit: 'Masāʾ al-khayr', meaning: 'Good evening.', emoji: '🌆', correct: true),
      GreetingChoice(translit: 'Masāʾ an-nūr', meaning: 'Good evening (reply).', emoji: '🌙', correct: false),
      GreetingChoice(translit: 'Ṣabāḥ al-khayr', meaning: 'Good morning.', emoji: '🌅', correct: false),
    ],
  ),
  GreetingQuestion(
    ...
    choices: [
      GreetingChoice(translit: 'Masāʾ an-nūr', meaning: 'Good evening (reply).', emoji: '🌙', correct: true),
      GreetingChoice(translit: 'Masāʾ al-khayr', meaning: 'Good evening.', emoji: '🌆', correct: false),
      GreetingChoice(translit: 'Ilā al-liqāʾ', meaning: 'See you again.', emoji: '🤝', correct: false),
      GreetingChoice(translit: 'Ṣabāḥ an-nūr', meaning: 'Good morning (reply).', emoji: '☀️', correct: false),
    ],
  ...
  GreetingQuestion(
    ...
    choices: [
      GreetingChoice(translit: 'Ilā al-liqāʾ', meaning: 'See you again.', emoji: '🤝', correct: false),
      GreetingChoice(translit: 'Alḥamdulillāh', meaning: 'All praise is due to Allah.', emoji: '🤍', correct: false),
      GreetingChoice(translit: 'Maʿa as-salāmah', meaning: 'Goodbye.', emoji: '🤗', correct: true),
      GreetingChoice(translit: 'As-salāmu ʿalaykum', meaning: 'Peace be upon you.', emoji: '🕊️', correct: false),
    ],
  ),
  GreetingQuestion(
    ...
    choices: [
      GreetingChoice(translit: 'Subḥānallāh', meaning: 'Glory be to Allah.', emoji: '✨', correct: false),
      GreetingChoice(translit: 'Ilā al-liqāʾ', meaning: 'See you again.', emoji: '🤝', correct: true),
      GreetingChoice(translit: 'Maʿa as-salāmah', meaning: 'Goodbye.', emoji: '🤗', correct: false),
      GreetingChoice(translit: 'Wa ʿalaykum as-salām', meaning: 'And peace be upon you too.', emoji: '🤲', correct: false),
    ],
  ),
...
const List<Destination> curriculum = [
  Destination(
    ...
    color: '#E8E4FF',
      ...
      Lesson(
        id: 'dest1-ayahBuilder-1',
        title: 'Ayah Builder',
        titleAr: 'بِنَاءُ الْآيَةِ',
        icon: '🧩',
        color: '#6C63D6',
        xp: 50,
        activities: [
        ...
        activities: [
          Activity(
            ...
            fiqhItems: [
              ...
              FiqhDragItem(id: 'u3', emoji: '👃', label: 'Rinse Nose', correctZoneId: '3'),
              FiqhDragItem(id: 'u4', emoji: '👤', label: 'Wash Face', correctZoneId: '4'),
              FiqhDragItem(id: 'u5', emoji: '💪', label: 'Wash Right Arm', correctZoneId: '5'),
              FiqhDragItem(id: 'u6', emoji: '💪', label: 'Wash Left Arm', correctZoneId: '6'),
              FiqhDragItem(id: 'u7', emoji: '🧕', label: 'Wipe Head', correctZoneId: '7'),
              FiqhDragItem(id: 'u8', emoji: '👂', label: 'Wipe Ears', correctZoneId: '8'),
              FiqhDragItem(id: 'u9', emoji: '🦶', label: 'Wash Right Foot', correctZoneId: '9'),
              FiqhDragItem(id: 'u10', emoji: '🦶', label: 'Wash Left Foot', correctZoneId: '10'),
            ],
            fiqhZones: [
              ...
              FiqhDropZone(id: 'slot6', label: 'Step 7'),
              FiqhDropZone(id: 'slot7', label: 'Step 8'),
              FiqhDropZone(id: 'slot8', label: 'Step 9'),
              FiqhDropZone(id: 'slot9', label: 'Step 10'),
            ],
          ),
        ],
      ),
